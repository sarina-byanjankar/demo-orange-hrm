...
class landingpage:
    # all the locators are degined under the constructor so that they can be easily accessed in the test functions, and also to avoid repeating the code in every test function
    def __init__(self, page):
        self.page = page
        self.brand_logo = self.page.locator(".orangehrm-login-branding")
        self.page_title = self.page.locator("h5.oxd-text")
